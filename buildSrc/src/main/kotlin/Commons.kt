object Dependencies {
    ...
    const val androidLiveData = "androidx.lifecycle:lifecycle-livedata-ktx:${Versions.androidLiveData}"
    ...
    const val androidViewModel = "androidx.lifecycle:lifecycle-viewmodel-ktx:${Versions.androidViewModel}"
